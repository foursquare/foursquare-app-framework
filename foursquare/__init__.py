...
class Foursquare(object):
    ...
    def set_access_token(self, access_token):
        ...
        self.base_requester.oauth_token = access_token
        self.base_requester.userless = False
    ...
    class Venues(_Endpoint):
        ...
        def links(self, VENUE_ID, params={}):
            """https://developer.foursquare.com/docs/venues/links"""
            return self.GET(u'{VENUE_ID}/links'.format(VENUE_ID=VENUE_ID), params)
    ...
    class Checkins(_Endpoint):
        ...
        def addpost(self, CHECKIN_ID, params):
            ...
            return self.POST(u'{CHECKIN_ID}/addpost'.format(CHECKIN_ID=CHECKIN_ID), params)
        ...
        def reply(self, CHECKIN_ID, params):
            ...
            return self.POST(u'{CHECKIN_ID}/reply'.format(CHECKIN_ID=CHECKIN_ID), params)
    ...
    class Specials(_Endpoint):
        ...
        def flag(self, SPECIAL_ID, params):
            ...
            return self.GET(u'{SPECIAL_ID}/flag'.format(SPECIAL_ID=SPECIAL_ID), params)
...
def _process_request(url, data=None):
    ...
    if GOOGLE_APP_ENGINE:
      # Doing this to avoid App Engine stupidity:
      ...
      with contextlib.closing(urllib.urlopen(url, data)) as request:
          ...
          if request.getcode() != 200:
            logging.error("error code %s" % (request.getcode()))
          if content_type:
      ...
      try:
          ...
          if meta:
              ...
              if exc:
                  ...
                  log.error(u'Unknown error type: {0}'
                            .format(meta.get('errorType')))
